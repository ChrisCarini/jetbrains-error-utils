...
public abstract class GitHubErrorReportSubmitter extends ErrorReportSubmitter {
    ...
    public boolean submit(
        ...
        try {
            ...
            final String stackTrace = event != null ? event.getThrowableText() : Messages.message("jetbrains.error.utils.github.error.report.submitter.no.stacktrace");
